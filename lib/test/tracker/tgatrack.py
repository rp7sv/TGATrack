...
class TGATrack(BaseTracker):
    def __init__(self, params):
        super(TGATrack, self).__init__(params)
        network = build_tgatrack(params.cfg, training=False)
    ...
    def track(self, image, seq_path: str = None, info: dict = None):
        H, W, _ = image.shape
        self.frame_id += 1
